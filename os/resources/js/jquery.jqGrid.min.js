												...
												case "script":
													b.ajax(b.extend({
														...
														success: function(e, f, h) {
															//customize json
															if (e.data && e.data.rows) {
																e.page = e.data.page;
																e.records = e.data.records;
																e.total = e.data.total;
																e.rows = e.data.rows;
																e.data.rows = null;
															}
